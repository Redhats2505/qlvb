...
<div class="col-xs-4 col-xs-offset-4">
    ...
    <form action="{{ url('/tailieu/update') }}" method="post"enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="description" name="description" placeholder="Diễn giải" value="{{ $gettailieuById[0]->description }}" required />
        </div>
        <div class="form-group">
    	...
    	<input type="date" class="form-control" id="date_expried"  name="date_expried" value="{{ $gettailieuById[0]->date_expried }}" />
        </div>
        <div class="form-group">
